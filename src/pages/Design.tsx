...
const interiorCategories = [{
  title: "Great Rooms",
  image: "https://mcdesign.bio/assets/detail-spa-vanity-BxlkwkET.jpg"
}, {
  title: "Primary Suites",
  image: "https://mcdesign.bio/assets/detail-marble-bath-BMs-D6Yk.jpg"
}, {
  title: "Chef's Kitchens",
  image: "https://mcdesign.bio/assets/detail-pro-range-Dljk2FL9.jpg"
}];
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`group relative overflow-hidden transition-all duration-700 delay-150 ${exteriorAnimation.isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
              <img src="https://mcdesign.bio/assets/detail-limestone-fireplace-D6LgYJBI.jpg" alt="Exterior spaces" className="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-[1.03]" />
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div ref={furnitureAnimation.ref} className={`group relative overflow-hidden transition-all duration-700 ${furnitureAnimation.isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
              <img src="https://mcdesign.bio/assets/detail-leather-cabinetry-BBj8D7nk.jpg" alt="Custom furniture" className="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-[1.03]" />
              <div className="absolute inset-0 bg-gradient-to-t from-charcoal/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
