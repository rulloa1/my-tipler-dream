        ...
        <section className="py-16 bg-charcoal">
          <div className="container mx-auto px-6">
            ...
            delay: 0.2
              ...
              {isAdmin && <p className="text-cream/60 text-sm mb-4">Enter a number to reorder images</p>}
              {isLoading ? <div className="text-cream/60">Loading gallery...</div> : <NumberedGallery images={galleryImages} projectTitle={project.title} onImageClick={openLightbox} onOrderChange={saveGalleryOrder} isEditable={isAdmin} />}
            </motion.div>
          </div>
        </section>
